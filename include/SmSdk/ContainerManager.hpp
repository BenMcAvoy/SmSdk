...
{
	/* 0x0000 */ uint16_t m_uMaxStackSize;
private:
...
public:
	...
	/* 0x0070 */ ContainerItems m_containerItems3;
private:
...
private:
	/* 0x0030 */ std::shared_ptr<Container2> m_pSomeContainer;
public:
	/* 0x0040 */ std::unordered_map<int, std::shared_ptr<Container2>> m_worldContainerMap; // NOTE: this naming inconsistency is intentional to match the original binary
private:
