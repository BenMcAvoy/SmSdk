...
private:
	...
	virtual void func10(const std::string& str, const std::string& str2, size_t idx, const Json::Value& json_val) { SMSDK_UNREF4(str, str2, idx, json_val); }
	virtual void func11() {}
	virtual void func12() {}
public:
...
public:
	/* 0x01A0 */ std::unordered_map<std::string, std::unordered_map<std::string, std::function<void(size_t, const Json::Value&)>>> m_mapMapCallbackStorage;
private:
